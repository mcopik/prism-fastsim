...
public abstract class SimulationMethod implements Cloneable
{
	...
	/**
	 * Check if computed result conforms to the one provided (e.g. in regression testing).
	 * However, it should be mentioned that wrong result may be caused by the confidence of obtained result.
	 * Method works for double values, the case of boolean results is trivial.
	 * @param expectedResult The expected result, a double.
	 * @param result The result obtained from simulation.
	 * @throws PrismException thrown when the result is too far from expected result
	 */
	public abstract void checkAgainstExpectedResult(double expectedResult, double result) throws PrismException;
